          ...
          <div className="bg-white px-6 py-8 mb-4 shadow-lg rounded-md m-4 md:m-0">
            <form onSubmit={submitForm}>
              ...
              <div className="mb-4">
                ...
                <select
                  value={salary}
                  onChange={(i) => setSalary(i.target.value)}
                  id="salary"
                  name="salary"
                  className="border rounded w-full py-2 px-3"
                  required
              ...
              <div className="mb-4">
                ...
                <input
                  value={companyName}
                  onChange={(i) => setCompanyName(i.target.value)}
                  type="text"
                  id="company"
                  name="company"
                  className="border rounded w-full py-2 px-3"
              ...
              <div className="mb-4">
                ...
                <textarea
                  value={companyDesc}
                  onChange={(i) => setCompanyDesc(i.target.value)}
              ...
              <div className="mb-4">
                ...
                <input
                  value={contactEmail}
                  onChange={(i) => setContactEmail(i.target.value)}
                  type="email"
                  id="contact_email"
                  name="contact_email"
                  className="border rounded w-full py-2 px-3"
              ...
              <div className="mb-4">
                ...
                <input
                  value={contactPhone}
                  onChange={(i) => setContactPhone(i.target.value)}
                  type="tel"
                  id="contact_phone"
                  name="contact_phone"
                  className="border rounded w-full py-2 px-3"
